...
<table class="table table-striped table-hover table-bordered">
	...
	<tbody>						
		...
		<?php endif; ?>
			<td style="text-align: center;"><?php echo $user['User']['id']; ?></td>
			...
			<div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
							...
							echo $this->Html->link("Inactive",array('action'=>'delete', $user['User']['id']),null,'Are you sure you want to inactive this user?');}
						else{
					    echo $this->Html->link(    "Re-Activate", array('action'=>'activate', $user['User']['id']));
					    }?>
						</li>
						<li><?php echo $this->Html->link(    "your_orders",   array('controller'=>'Products','action'=>'order_list', $user['User']['id']) ); ?></li>
                        </ul>
                        </div>
