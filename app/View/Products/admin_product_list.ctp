...
<table  class="table table-striped table-hover table-bordered">
    <thead>
		<tr>
			...
			<th><?php echo $this->Paginator->sort('size', ' Available Size');?></th>
	...
	<tbody>						
      ...
      //pr($product['Gallery'][0]['images']); exit;		?>
		...
		<?php endif; ?>
		    <td style="text-align: center;"><?php echo $product['Product']['id']; ?></td>
			<td><?php if($product['Gallery']!= ''){
					  echo $this->Html->image('/files/thumbs100x100/'.$product['Gallery'][0]['images']); 
					  }?></td>
			<td style="text-align: center;"><?php echo $this->Html->link( $product['Product']['product_name']  ,   array('action'=>'product_detail', $product['Product']['id']),array('escape' => false) );?></td>
			<td style="text-align: center;"><?php echo $product['Product']['product_number']; ?></td>
			<td style="text-align: center;"><?php echo $product['Product']['size']; ?></td>
			<td style="text-align: center;"><?php echo $product['Product']['material']; ?></td>
			...
			<div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <li><?php if($product['Product']['status'] != "Inactive"){
							echo $this->Html->link("In-active",array('action'=>'delete', $product['Product']['id']),null,'Are you sure you want to delete this Product ?');}
						else{
